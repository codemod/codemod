...
{/* Rename from quickstart to introduction. Consider adding a quickstart section that links to different guides for framework builders, people looking for running codemods, etc. */}
...
<Card title="For Framework Builders & OSS Community" icon="github-alt" href="/quickstart-oss">
...
<Card title="For Enterprise Engineering Teams" icon="people-group" href="/quickstart-enterprise">
