...
<Info>
For engine details and built-ins, see <a href="/guides/jssg/reference#runtime-and-built-ins">Runtime and built-ins</a> in the API reference.
</Info>
...
<Tip>
You can author rules as plain JavaScript objects. See the [ast‑grep rule configuration docs](https://ast-grep.github.io/guide/rule-config.html) and the [jssg API reference](/guides/jssg/reference#rule-configuration).
</Tip>
