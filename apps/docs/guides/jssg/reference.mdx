...
Complete API reference for JavaScript ast-grep (jssg) codemods. Use this guide to understand all available methods, types, and patterns for building robust code transformations.
