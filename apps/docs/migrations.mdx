...
While a campaign may be as simple as a single automated codemod, most migrations involve a sequence of steps. You can design those steps by building [Codemod Packages](/cli/packages). Alternatively, pro and enterprise customers can request custom workflows by [contacting us](https://go.codemod.com/contact).
