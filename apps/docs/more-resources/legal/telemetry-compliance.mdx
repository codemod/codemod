...
The extension tracks the events happening within the extension and they have following properties (this is described in the extension’s [source code](https://github.com/codemod-com/codemod/blob/legacy/apps/vsce/src/telemetry/telemetry.ts)).
