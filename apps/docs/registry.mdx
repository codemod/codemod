...
The **Codemod Registry** is a centralized repository for discovering, consuming, and distributing [Codemod packages](/cli/packages/quickstart). It enables the community to share reusable code transformation tools and allows organizations to maintain private codemods for their internal use.

## What is Codemod Registry?

The Codemod Registry is a package registry similar to npm, but specifically designed for Codemod packages. It provides:
