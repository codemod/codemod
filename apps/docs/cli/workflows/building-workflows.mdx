...
<Tabs>
  <Tab title="Shell command step">
    ...
    <ParamField path="use" type="object">
    Call a template within a step.
  ...
  <Tab title="YAML ast-grep step">
    ...
    <ParamField path="ast-grep.allow_dirty" type="boolean" default="false">
      Allow dirty files.
    </ParamField>
  </Tab>
  ...
  <Tab title="AI step">
    ...
    <ParamField path="ai.timeout_ms" type="number">
...
<CardGroup cols={2}>
  ...
  <Card title="Build Workflows with Codemod MCP" icon="robot" href="/mcp/building-workflows">
