...
3. Install package-specific skills with `npx codemod <package-id> --skill` when a package exposes installable skill behavior (required for skill-only packages).
