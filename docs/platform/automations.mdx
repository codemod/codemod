...
The **Scan Codebase** action uses the same query model as [Insights](/platform/insights). It can run ast-grep rules, JSSG queries, or [Smart](/platform/insights#smart-queries) natural-language file checks.
