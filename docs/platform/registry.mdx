...
The **Codemod Registry** is a centralized repository for discovering, consuming, and distributing [Codemod packages](/workflows/quickstart). It enables the community to share reusable code transformation tools and allows organizations to maintain private codemods for their internal use. It provides:
...
To publish packages under your organization's scope (e.g., `@your-org/my-codemod`), you need to link your GitHub organization to Codemod:

<Steps>
  <Step title="Install the Codemod GitHub App">
    1. Go to [github.com/apps/codemod](https://github.com/apps/codemod)
    2. Click **Install** and select your GitHub organization
    3. Grant access to at least one repository (this links your org to Codemod)
    
    <Note>You must be a GitHub organization **admin** to install the app.</Note>
  </Step>
  
  <Step title="Sign in to Codemod">
    Sign in at [codemod.com](https://codemod.com) with your GitHub account. Your organization scope will be automatically reserved.
  </Step>
</Steps>

Once linked, anyone who can trigger GitHub Actions in your organization's repositories can publish codemods under your scope using [trusted publishers](/publishing#trusted-publishers).
...
Learn more about [configuring packages](/workflows/building-workflows#package-metadata-codemod-yaml).
...
Learn more about [using Codemod packages in workflows](/workflows/building-workflows#codemod-registry-step).
