...
import { CodemodCampaignsDemo } from "/snippets/codemod-campaigns-demo.mdx";

<Frame>
  <CodemodCampaignsDemo />
</Frame>
...
<Steps>
  ...
  <Step title="Configure parameters">
    ...
    - **JSSG transforms**: Access parameters via `options.params`. See [JSSG documentation](/jssg/advanced#parameters-and-configuration) for details.
