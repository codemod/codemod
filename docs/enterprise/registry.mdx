...
The **Codemod Registry** is a centralized repository for discovering, consuming, and distributing [Codemod packages](/community/package-structure). It enables the community to share reusable code transformation tools and allows organizations to maintain private codemods for their internal use. It provides:
...
To publish packages under your organization's scope (e.g., `@your-org/my-codemod`), you need to link your GitHub organization to Codemod platform. See [Linking Your GitHub Organization](/community/publishing#linking-your-github-organization) for step-by-step setup instructions.
...
Learn more about search options in the [CLI Reference](/community/cli#codemod-search).
...
Learn more about [configuring packages](/community/package-structure#package-metadata-codemod-yaml).
...
Learn more about [using Codemod packages in workflows](/community/workflows/reference#codemod-registry-step).
...
- Use [jssg testing](/community/jssg/testing) for automated test cases
