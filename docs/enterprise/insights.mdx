...
JSSG codemod queries use [JSSG](/community/jssg/intro) for static analysis and custom metrics. Use them when you need programmatic logic, package-backed metrics, semantic analysis, or dimensions beyond a simple syntax match.
...
<CardGroup cols={2}>
  ...
  <Card
    ...
    href="/enterprise/codemod-studio"
