...
See [JSSG (JS ast-grep) queries](/enterprise/insights/jssg-queries).

### ast-grep YAML queries

See [ast-grep YAML queries](/enterprise/insights/ast-grep-queries).

### Dependency queries

See [Package dependency queries](/enterprise/insights/dependency-queries).

### Smart queries

See [Smart (Jev-powered) queries](/enterprise/insights/smart-queries).
