...
<Steps>
  <Step title="Discover a Codemod package in the Registry">
    ...
    The registry includes Codemod packages for framework upgrades, security patches, API migrations, code modernization patterns, and [more](/introduction#codemod-platform-core-features).
  </Step>
  ...
  <Step title="Apply a Codemod package to your repository">
    ...
    <Tip>
      To run a codemod without signing in, use the [CLI](/community/cli). Each Codemod package's registry page includes a copy-able command you can run locally.
  ...
  <Step title="Install the GitHub or GitLab App (if needed)">
    ...
    <CardGroup cols={2}>
      <Card title="GitHub" icon="github" href="/enterprise/integrations/github">
        Install the Codemod GitHub App
      </Card>
      <Card title="GitLab" icon="gitlab" href="/enterprise/integrations/gitlab">
...
<b>Learn more:</b> [GitHub Integration](/enterprise/integrations/github#managing-team-members) or [GitLab Integration](/enterprise/integrations/gitlab#managing-team-members) for manual invites, or [SAML SSO](/enterprise/saml#user-provisioning-and-access-control) for IdP-based access control.
</Card>

<Card title="Search with Grep" icon="magnifying-glass">
  Index repositories you can access, then search them with Pattern, Regex, or ast-grep YAML queries. Turn a completed search into an Insights dashboard when you want ongoing tracking.

  <b>Learn more:</b> [Grep Documentation](/enterprise/grep)
</Card>
...
<Card title="Set up Insights" icon="chart-line-up-down">
  ...
  <b>Learn more:</b> [Insights Documentation](/enterprise/insights)
</Card>

<Card title="Create Automations" icon="bolt">
React to schedules, webhooks, and repository events so Codemod can start repeatable maintenance work without a manual campaign setup each time.

<b>Learn more:</b> [Automations Documentation](/enterprise/automations)
</Card>
...
<b>Learn more:</b> [Workflow Reference](/community/workflows/reference) covers manual triggers, matrix strategies, state management, and parameters.
</Card>
...
<b>Learn more:</b> [Codemod Registry](/enterprise/registry#private-access)
</Card>
...
<b>Learn more:</b> [Jira Integration](/enterprise/integrations/jira)
</Card>
