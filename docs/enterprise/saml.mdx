...
- [GitHub Integration](/enterprise/integrations/github)
- [GitLab Integration](/enterprise/integrations/gitlab)
...
Once a user has signed in, an organization Admin can change their **role** (Admin, Member, or Viewer) from **Organization Settings** → **Members**. See [Managing team members](/enterprise/integrations/github#managing-team-members) for role definitions.
