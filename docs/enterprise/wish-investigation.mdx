...
<AccordionGroup>
  ...
  <Accordion title="The report shows partial coverage">
    Open **Queries** to find limited or failed searches, then review **Limitations** for the affected conclusions and suggested next checks. You can start a narrower follow-up investigation if the original question covered too much code.
  </Accordion>
