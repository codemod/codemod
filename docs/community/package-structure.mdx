...
| `workflow.yaml` | [Workflow definition](/community/workflows/reference) with nodes and steps |
| `scripts/` | JavaScript/TypeScript codemods ([JSSG](/community/jssg/intro)) |
...
<Tip>
See <a href="/community/jssg/security">Security & Capabilities</a> for detailed information about the security model and usage examples.
</Tip>
</ParamField>
...
<CardGroup cols={2}>
  ...
  <Card title="JSSG" icon="code" href="/community/jssg/intro">
