...
<Card title="Prompting best practices" icon="lightbulb" href="/community/model-context-protocol#best-practices">
  Tips for writing effective prompts and getting the most out of building codemods with AI.
</Card>

You will end up with a [Codemod package](/community/package-structure):
...
For test structure, CI integration, and debugging strategies, see [Testing](/community/jssg/testing).
...
For CI/CD automation, trusted publishers, and API keys, see the [Publishing guide](/community/publishing).

## Next steps

### Scale your migrations

Your migration experience does not stop here. When you're managing migrations across large codebases or multiple teams, the same codemod package can power [Campaigns](/enterprise/campaigns) for automated multi-repo rollouts and [Insights](/enterprise/insights) for tracking adoption progress.

See the [Platform quickstart](/enterprise/quickstart) for the full enterprise workflow.
...
<CardGroup cols={2}>
  <Card title="CLI reference" icon="terminal" href="/community/cli">
    Full CLI command reference.
  </Card>
  <Card title="Workflow reference" icon="diagram-project" href="/community/workflows/reference">
