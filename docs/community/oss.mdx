...
<Frame>
  <div style={{ position: 'relative', paddingBottom: 'calc(62.5% + 41px)', height: '0', width: '100%' }}>
    <iframe
      src="https://demo.arcade.software/QEtLo6oVoxUnNNejORqp?embed&embed_mobile=inline&embed_desktop=inline&show_copy_link=true"
      title="Quickstart"
      frameBorder="0"
      loading="lazy"
      allowFullScreen
...
If you do not know how to build or publish codemods yet, check out the following guides: 
  - [Build your first codemod with MCP](/community/oss-quickstart#2-scaffold-and-build-your-codemod)
  - Use [Codemod Studio](/enterprise/codemod-studio) for:
    * A live codemod runner
    * An AST viewer
    * Shareable links with test fixtures for review and debugging
  - [Publishing codemods](/community/publishing) to the registry.
  </Tip>
...
<CardGroup cols={2}>
  <Card title="CLI" icon="terminal" href="/community/cli">
  ...
  <Card title="JSSG" icon="js" href="/community/jssg/intro">
    Learn the transformation engine in depth.
  </Card>
  <Card title="Publishing" icon="upload" href="/community/publishing">
