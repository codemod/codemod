...
| Step Type | Purpose |
|-----------|---------|
| `js-ast-grep` | JavaScript/TypeScript codemods using [JSSG](/community/jssg/intro) |
...
<CardGroup cols={2}>
  <Card title="Create a Package" icon="plus" href="/community/oss-quickstart">
  ...
  <Card title="JSSG Intro" icon="code" href="/community/jssg/intro">
    Write JavaScript/TypeScript transformations.
  </Card>
  <Card title="CLI Reference" icon="terminal" href="/community/cli#codemod-workflow">
