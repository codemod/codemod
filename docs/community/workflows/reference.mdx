...
<Card title="JSSG Documentation" icon="code" href="/community/jssg/intro">
...
In dry-run mode, this step is skipped. In non-interactive runs, it is also skipped by default unless the workflow is run with `--install-skill`. See [CLI reference](/community/cli#codemod-workflow).
...
<Card title="Sharding Guide" icon="layer-group" href="/community/workflows/sharding">
...
<Card title="Advanced Parameter Usage" icon="gear" href="/community/jssg/advanced#parameters-and-configuration">
