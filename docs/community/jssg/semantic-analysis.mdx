...
<CardGroup cols={2}>
<Card title="API Reference" icon="book" href="/community/jssg/reference">
Complete API documentation for SgNode and SgRoot methods.
</Card>

<Card title="Advanced Patterns" icon="code" href="/community/jssg/advanced">
  Learn advanced transformation techniques and best practices.
</Card>

<Card title="Testing" icon="flask" href="/community/jssg/testing">
  Test your codemods with fixtures and the test runner.
</Card>

<Card title="Security" icon="shield-check" href="/community/jssg/security">
