...
<Info>
Semantic analysis is only supported for **JavaScript/TypeScript** (using oxc) and **Python** (using ruff). For other languages, these methods return null or empty arrays. See [Semantic Analysis](/community/jssg/semantic-analysis) for details.
</Info>
