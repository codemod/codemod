...
- **Wish AI assistant—now smarter**: Choose your preferred AI model, get prompt suggestions, and leverage semantic search and grep tools for more powerful code exploration. Messages now persist across sessions for continuity.
