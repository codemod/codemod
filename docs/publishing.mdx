...
You can also run `npx codemod init` to scaffold a Codemod package, including publish workflow templates you can adapt for your repository layout. For monorepos, use the package path and tag pattern that match how you organize packages in your repo.
