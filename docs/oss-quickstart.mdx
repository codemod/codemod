...
During scaffolding, you can pick from built-in starter targets for TypeScript, Python, Rust, Go, Java, HTML, XML, CSS, Kotlin, Angular, C#, C++, C, PHP, Ruby, Elixir, JSON, YAML, and TOML.
