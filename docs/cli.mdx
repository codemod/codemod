...
Install the `codemod` MCS skill package, configure Codemod MCP, and install the Codemod creation entrypoint where the harness supports it.
...
`agent install` also installs `/codemod-create` where the harness has a native command or workflow file surface:
- `claude`: `./.claude/commands/codemod-create.md` (project), `~/.claude/commands/codemod-create.md` (user)
- `goose`: `~/.config/goose/recipes/codemod-create.yaml` + `~/.config/goose/config.yaml` registration (user only)
- `opencode`: `./.opencode/commands/codemod-create.md` (project), `~/.config/opencode/commands/codemod-create.md` (user)
- `cursor`: `./.cursor/commands/codemod-create.md` (project), `~/.cursor/commands/codemod-create.md` (user)
- `antigravity`: `./.agents/workflows/codemod-create.md` (project), `~/.gemini/antigravity/global_workflows/codemod-create.md` (user)
