...
<ResponseField name="--semantic" type="boolean">
  Use semantic comparison for test outputs. Ignores non-semantic differences like property ordering in objects, import ordering, and keyword argument ordering. Supported languages: JavaScript, TypeScript, Python, Go, Rust, JSON.
</ResponseField>
