...
Both workflows use [trusted publishers](/publishing#trusted-publishers) with OIDC for secure, passwordless publishing. Before the workflow can publish packages under an organization scope, you must first verify that scope through the GitHub App or a public repository as described in the publishing guide.
