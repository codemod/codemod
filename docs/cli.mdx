...
`agent install` also installs `/codemod` where the harness has a native command or workflow file surface:
...
- `antigravity`: `./.agents/workflows/codemod.md` (project), `~/.gemini/antigravity/global_workflows/codemod.md` (user)
