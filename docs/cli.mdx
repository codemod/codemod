...
This is the command that `codemod ai` installs into supported MCP client configurations.
...
<ResponseField name="--usage-log <PATH>" type="string">
  Write MCP usage events to a file for debugging MCP client integrations.
</ResponseField>
