...
- `npx codemod ai docs`: list, read, or search docs-backed resources through the CLI
- `npx codemod ai resources`: list MCP-equivalent resources exposed by the CLI
- `npx codemod ai resource <uri-or-name>`: read one MCP-equivalent resource by URI or resource name
