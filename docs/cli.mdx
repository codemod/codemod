...
| Package structure validation     | Workflow/skill layout matches the selected package behavior             |
| Skill frontmatter validation     | Authored package skills include required metadata and compatibility     |
| Skill references/layout checks   | Referenced authored skill files exist and the install payload is usable |
