...
<CardGroup cols={3}>
  ...
  <Card title="Automations" icon="bolt" href="/enterprise/automations">
    React to events and start repeatable codebase maintenance.
  </Card>
  ...
  <Card title="Studio" icon="wrench" href="/enterprise/codemod-studio">
    Generate and test codemods with AI assistance.
  </Card>

  <Card title="MCP" icon="screwdriver-wrench" href="/community/model-context-protocol">
    Give your AI tools for codemod creation.
  </Card>

  <Card title="Codemod Wish" icon="wand-magic-sparkles" href="/enterprise/codemod-wish">
    Ask Codemod AI for help across the platform.
  </Card>
...
<Card title="Enterprise engineering teams" icon="people-group" href="/enterprise/quickstart">
...
<Card title="Open-source maintainers" icon="github-alt" href="/community/oss">
