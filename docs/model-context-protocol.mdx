...
For maintainer-oriented repository layout and multi-package publishing guidance, use `codemod-maintainer-monorepo-instructions`. That resource maps to the package layout and publishing docs for multi-codemod repositories, including `package-structure` and `publishing`.
