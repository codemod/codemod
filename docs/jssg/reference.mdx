...
### Supported language imports
- `codemod:ast-grep/langs/javascript`
- `codemod:ast-grep/langs/typescript`
- `codemod:ast-grep/langs/tsx`
- `codemod:ast-grep/langs/python`
- `codemod:ast-grep/langs/rust`
- `codemod:ast-grep/langs/go`
- `codemod:ast-grep/langs/java`
- `codemod:ast-grep/langs/xml`
- And other generated language modules shipped in `@codemod.com/jssg-types`
...
You can import language-specific AST typings from `codemod:ast-grep/langs/*`. For example, XML transforms now use `import type XML from "codemod:ast-grep/langs/xml"`.
