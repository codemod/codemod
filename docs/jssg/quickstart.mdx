...
title: "Introduction"
---
JavaScript ast-grep (JSSG) is a toolkit for building, testing, and running deterministic codemods. 
...
- [LLRT](./reference#runtime-and-built-ins) for Node.js module compatibility (e.g., `fs`, `process`).
