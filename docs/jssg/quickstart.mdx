...
- The `codemod:runtime` built-in lets codemods report structured progress, warnings, the active unit being processed, and explicit failures back to the engine and TUI.
