...
## [codemod-cli@1.15.3] - 2026-08-25

### 🐛 Bug Fixes

- *(cli)* Fall back to builder tag (CDMD-4903) (#2396)
- *(sandbox)* Expose runtime module in memory (#2400)

### 📚 Documentation

- Document package dashboard templates for JSSG publishes (#2398)

### ⚙️ Miscellaneous Tasks

- Run TUI perf workflow only on relevant path changes (#2399)
- *(bump)* Bump codemod crates version to v1.15.3 (#2397)
...
- *(bump)* Bump codemod crates version to v1.15.1 (#2391)

### CDMD-4897

- Add repository manifest command (#2385)

### CDMD-4899

- Add Builder stable publish workflow (#2386)
...
## [codemod-cli@1.14.1] - 2026-08-13

### ⚙️ Miscellaneous Tasks

- *(bump)* Bump codemod crates version to v1.14.1 (#2388)
...
## [codemod-cli@1.13.19] - 2026-08-08

### 🚀 Features

- *(telemetry)* Implement composite telemetry sender and integrate Scarf gateway (#2376)

### 📚 Documentation

- Document repository scope verification (#2373)

### ⚙️ Miscellaneous Tasks

- Update port login screen (#2280)
- *(bump)* Bump codemod crates version to v1.13.19 (#2378)
...
## [codemod-cli@1.13.18] - 2026-08-03

### 🐛 Bug Fixes

- *(cli)* Secure auth token file permissions (#2237)

### ⚙️ Miscellaneous Tasks

- *(bump)* Bump codemod crates version to v1.13.18 (#2370)
...
## [codemod-cli@1.13.17] - 2026-07-31

### 🐛 Bug Fixes

- *(cli)* Count nested codemod runs (#2364)

### ⚙️ Miscellaneous Tasks

- *(bump)* Bump codemod crates version to v1.13.17 (#2366)
...
## [codemod-cli@1.13.15] - 2026-07-30

### 🚀 Features

- *(cli)* Meter nested codemod LLM usage (#2351)

### ⚙️ Miscellaneous Tasks

- *(bump)* Bump codemod crates version to v1.13.15 (#2355)
...
## [codemod-cli@1.12.14] - 2026-07-17
...
## [codemod-cli@1.12.10] - 2026-07-09

### 🐛 Bug Fixes

- Resolve target directory expr in sharding workflow steps (#2311)

### ⚙️ Miscellaneous Tasks

- *(bump)* Bump codemod crates version to v1.12.10 (#2312)
...
## [codemod-cli@1.12.9] - 2026-07-09

### ⚙️ Miscellaneous Tasks

- *(bump)* Bump codemod crates version to v1.12.9 (#2307)
...
- *(CDMD-4835, CDMD-4836)* Harden workflow shell execution (#2287)

### ⚙️ Miscellaneous Tasks

- *(bump)* Bump codemod crates version to v1.12.7 (#2291)
...
## [codemod-cli@1.12.6] - 2026-06-26

### 🚀 Features

- *(jssg-utils)* Add support to dynamic imports with cb (#2162)
- Support feedback in report UI (#2281)

### ⚙️ Miscellaneous Tasks

- *(bump)* Bump codemod crates version to v1.12.6 (#2283)
...
## [codemod-cli@1.12.5] - 2026-06-19

### 🚀 Features

- *(cli)* Enforce pro/dry-run semantics for bundled child codemods (#2266)

### ⚙️ Miscellaneous Tasks

- *(bump)* Bump codemod crates version to v1.12.5 (#2269)
...
## [codemod-cli@1.12.3] - 2026-06-04

### 🚀 Features

- *(jssg)* Python enhancements (#2253)

### ⚙️ Miscellaneous Tasks

- *(bump)* Bump codemod crates version to v1.12.3 (#2256)
...
- Refactor CLI (#2189)
- *(bump)* Bump codemod crates version to v1.9.4 (#2200)
...
## [codemod-cli@1.9.3] - 2026-05-07

### 🐛 Bug Fixes

- *(logging)* Enhance structured logging with parsed log line support (#2178)

### ⚙️ Miscellaneous Tasks

- *(bump)* Bump codemod crates version to v1.9.3 (#2182)
...
## [codemod-cli@1.9.2] - 2026-05-06

### 📚 Documentation

- Add support for multiple workflows in packages and update sharding documentation (#2163)
- April 2026 product updates (#2169)

### ⚙️ Miscellaneous Tasks

- *(logs)* Remove unnecessary logging noise from workflow resume and structured log (#2174)
- *(bump)* Bump codemod crates version to v1.9.2 (#2175)
...
## [codemod-cli@1.9.0] - 2026-04-28

### 🚀 Features

- Multi workflow and fix opencode agent handoff (#2158)

### 🐛 Bug Fixes

- *(tui)* Multiple fixes (#2157)

### ⚙️ Miscellaneous Tasks

- *(bump)* Bump codemod crates version to v1.9.0 (#2159)
...
## [codemod-cli@1.8.4] - 2026-04-27

### 🐛 Bug Fixes

- *(cli)* Route sandbox failures to task logs (#2138)
- *(docs)* Saml info (#2094)

### ⚙️ Miscellaneous Tasks

- *(bump)* Bump codemod crates version to v1.8.4 (#2153)
