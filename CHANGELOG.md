...
## [codemod-cli@1.0.12] - 2025-09-15

### 🚀 Features

- *(cli)* Add support for matrix values and thread configuration in jssg commands
- *(workflow)* Improved schema system for params and states

### 🐛 Bug Fixes

- *(engine)* Fix variable resolution escaping whitespaces

### ⚙️ Miscellaneous Tasks

- Fix failing tests missing params in workflow settings
- *(bump)* Bump codemod crates version to v1.0.12
