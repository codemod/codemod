...
## [codemod-cli@1.3.14] - 2026-01-29

### 🚀 Features

- *(cli)* Ignore comments order for loose strictness (#1948)

### 🐛 Bug Fixes

- Avoid sending failure kind of event when cdmd succeeds (#1950)

### 📚 Documentation

- Document SAML integration (#1951)

### ⚙️ Miscellaneous Tasks

- *(bump)* Bump codemod crates version to v1.3.14 (#1954)
