...
## [codemod-cli@1.12.15] - 2026-07-29

### 🐛 Bug Fixes

- *(cli)* Make codemod run telemetry reliable (#2339)
- *(ci)* Run telemetry check with bash (#2344)

### ⚙️ Miscellaneous Tasks

- *(bump)* Bump codemod crates version to v1.12.14 (#2341)
- *(bump)* Bump codemod crates version to v1.12.15 (#2347)

## [codemod-cli@1.12.13] - 2026-07-17

### 🚀 Features

- *(cli)* Add Registry button to report UI (#2286)

### 🐛 Bug Fixes

- *(sandbox)* Honor withFileTypes Dirents in curated fs (#2330)

### 🚜 Refactor

- *(cli)* Update Registry button styling and logic (#2328)

### ⚙️ Miscellaneous Tasks

- *(bump)* Bump codemod crates version to v1.12.13 (#2332)
...
- *(logging)* Enhance JSSG execution service to emit structured logs for runtime events (#2317)

### ⚙️ Miscellaneous Tasks

- *(bump)* Bump codemod crates version to v1.12.11 (#2319)
