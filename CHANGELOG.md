...
## [codemod-cli@1.0.10] - 2025-09-14

### 🚀 Features

- *(cli)* Enhance jssg configuration system with hierarchical support
- *(cli)* Add parameters support to jssg configuration

### 🐛 Bug Fixes

- *(testing-utils)* Convert input/expected tests to hashmap
- Improve logic to just replace the input by expected once

### ⚙️ Miscellaneous Tasks

- *(testing-utils)* Rename let input_name with input_path
- Lint
- *(bump)* Bump codemod crates version to v1.0.10
