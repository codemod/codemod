...
## [codemod-cli@1.3.5] - 2025-12-12

### 🚀 Features

- Add getStepOutput type into jssg-types for workflow global package

### 🐛 Bug Fixes

- Update semantic analysis support for enterprise (#1890)
- Fix issues

### 🚜 Refactor

- Reafctor from text storing variables into Hashmap for better performance in concurrency saturation and add get_or_set_step_output function

### ⚙️ Miscellaneous Tasks

- *(bump)* Bump codemod crates version to v1.3.5
