...
## [codemod-cli@1.14.0] - 2026-08-12

### 🚀 Features

- *(feedback)* Truncate error messages to a maximum length and improve error display formatting (#2380)
- Interactive capability approval (#2381)

### ⚙️ Miscellaneous Tasks

- *(bump)* Bump codemod crates version to v1.14.0 (#2382)
